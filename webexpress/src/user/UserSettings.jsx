import React, { useState } from 'react';
  ...
  function SideNav({ onFeedback, onLogout, onProfileClick }) {
    return (
      <div
        style={{
          minWidth: 220,
      ...
      >
        ...
        <div className="sidenav-action-item" style={{ cursor: 'pointer',  fontWeight: 500, transition: 'none' }} onClick={onFeedback}>
          Give us feedback!
        </div>
  ...
  export default function UserSettings() {
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#fff' }}>
        ...
        >
          <SideNav onFeedback={() => setShowFeedback(true)} onLogout={handleLogout} onProfileClick={() => setShowProfileInfo(true)} />
