...
const MessagePopup = ({ open, title, description, onClose, style = {} }) => {
  if (!open) return null;
  return (
    <div style={{
      position: 'fixed',
      ...
      >
        ...
        <div style={{ fontSize: '1.1em', color: '#42526E', textAlign: 'center', marginBottom: 8 }}>{description}</div>
        <div style={{ display: 'flex', gap: '1em', marginTop: '1.5em', width: '100%', justifyContent: 'center' }}>
          <button
            type="button"
            onClick={onClose}
            style={{
